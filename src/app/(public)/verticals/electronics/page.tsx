...
export const metadata = {
  title: 'IT & Electronics Contracts — Signet AI',
  description: 'AI contract analysis for IT businesses, SaaS vendors, and electronics SMEs in Tamil Nadu.'
}

const RISKS = [
  { risk: 'IP ownership of custom software', desc: 'Work-for-hire clauses that transfer your IP to the client', severity: 'high' },
  { risk: 'Data ownership and portability', desc: 'Contracts that lock your data when you switch vendors', severity: 'high' },
  { risk: 'Unlimited service level penalties', desc: 'Disproportionate penalties for minor downtime', severity: 'medium' },
  { risk: 'Auto-renewal with long notice periods', desc: 'Locked into unfavourable SaaS terms for extended periods', severity: 'medium' },
  { risk: 'Limitation of liability below coverage', desc: 'Liability caps below your insurance coverage create gaps', severity: 'medium' },
]
    ...
    <div>
      ...
      <section style={{ background: '#0D1B2A', padding: '120px 24px 96px', textAlign: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <span style={{ fontSize: 12, fontWeight: 600, color: '#1D9E75', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 12, display: 'block' }}>IT & ELECTRONICS</span>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 44, color: '#FFFFFF', fontWeight: 400, lineHeight: 1.15, margin: '0 0 20px 0' }}>
            IT, SaaS & Electronics contracts — protect your IP, data, and revenue.
          </h1>
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.65)', maxWidth: 660, margin: '0 auto 36px', lineHeight: 1.65 }}>
            SaaS vendor agreements, data ownership clauses, IP work-for-hire, and service level agreements — all checked automatically.
          </p>
          <Link href="/login" className="btn-cta">
            Analyse a vendor agreement free →
          </Link>
        </div>
      </section>
      ...
      <section style={{ background: '#09111E', padding: '96px 24px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 840, margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 32, color: '#FFFFFF', fontWeight: 400, margin: '0 0 40px 0' }}>
            Key risks for IT & electronics businesses
          </h2>
      ...
      <section style={{ background: '#0D1B2A', padding: '72px 24px', textAlign: 'center' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 32, color: '#FFFFFF', fontWeight: 400, margin: '0 0 28px 0' }}>Ready to protect your vendor agreements?</h2>
        <Link href="/login" className="btn-cta">
          Analyse a vendor agreement free →
        </Link>
      </section>
